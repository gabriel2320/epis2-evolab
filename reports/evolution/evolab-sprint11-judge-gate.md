...
- ✓ golden-010: golden=noise predicted=noise
...
- ✓ golden-014: golden=noise predicted=noise
- ✓ golden-015: golden=signal predicted=signal
- ✗ golden-016: golden=noise predicted=signal
- ✓ golden-017: golden=noise predicted=noise
- ✓ golden-018: golden=noise predicted=noise
- ✓ golden-019: golden=noise predicted=noise
- ✗ golden-020: golden=noise predicted=duplicate
- ✓ golden-021: golden=noise predicted=noise
- ✓ golden-022: golden=signal predicted=signal
- ✓ golden-023: golden=signal predicted=signal
- ✓ golden-024: golden=noise predicted=noise
- ✓ golden-025: golden=noise predicted=noise